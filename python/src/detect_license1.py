...
output_video_path = f'{Path(video_path).parent.absolute()}/output_{video_name}.avi'
out = cv2.VideoWriter(output_video_path, fourcc, 20.0, (1280, 720))  # Adjust frame rate (20.0) as needed
